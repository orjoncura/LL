    ...
    const handleSubmit = (event:any) => {
        ...
        try {
              if(IsValidPassword(password) == false || IsValidPassword(confirmPassword) == false) {
                ...
                showFeedback("Invalid Password", "Please make sure that the password contains a capital letter and a symbol."); 
                return;
              }
              ...
              POST('/Security/CompleteUserRegistration', JSON.stringify(data))
                .then(isSuccessfull => { 
                  ...
                  if(isSuccessfull) {
                      ...
                      showFeedback("Success", "Your new account has been created successfully", fun);
