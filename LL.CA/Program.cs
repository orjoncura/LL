...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        try
        {
            ...
            //string text = "de – of/from, la – the, que – that/which el – the, en – in/on, y – and a – to/at, los – the (masculine plural article), se – oneself, del – from the las – the (feminine plural article), un – a/an, por – by/for/through, con – with no – no/not, una – a/an/one, su – his/her/its/your, para – for/to/in order to, es – is, al – to the ";
