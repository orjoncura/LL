    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseWordRank", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseWordRankId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedById = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseWords_CourseWordRank_CourseWordRankId",
                        column: x => x.CourseWordRankId,
                        principalTable: "CourseWordRank",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "CourseWordRank",
                columns: new[] { "Id", "CreatedDate", "Value" },
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(6518), new TimeSpan(0, 0, 0, 0, 0)), "High" },
                    { 2, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(6524), new TimeSpan(0, 0, 0, 0, 0)), "Medium" },
                    { 3, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(6526), new TimeSpan(0, 0, 0, 0, 0)), "Low" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(1633), new TimeSpan(0, 0, 0, 0, 0)), "English" },
                    { 2, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(1637), new TimeSpan(0, 0, 0, 0, 0)), "Spanish" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(1115), new TimeSpan(0, 0, 0, 0, 0)), "Queued" },
                    { 2, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(1158), new TimeSpan(0, 0, 0, 0, 0)), "Sent" },
                    { 3, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(1161), new TimeSpan(0, 0, 0, 0, 0)), "Failed" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3904), new TimeSpan(0, 0, 0, 0, 0)), "Noun" },
                    { 2, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3910), new TimeSpan(0, 0, 0, 0, 0)), "Verb" },
                    { 3, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3912), new TimeSpan(0, 0, 0, 0, 0)), "Adjective" },
                    { 4, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3913), new TimeSpan(0, 0, 0, 0, 0)), "Adverb" },
                    { 5, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3914), new TimeSpan(0, 0, 0, 0, 0)), "Interjection" },
                    { 6, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3917), new TimeSpan(0, 0, 0, 0, 0)), "Preposition" },
                    { 7, new DateTimeOffset(new DateTime(2025, 1, 6, 23, 41, 18, 892, DateTimeKind.Unspecified).AddTicks(3918), new TimeSpan(0, 0, 0, 0, 0)), "Pronoun" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseWords_CourseWordRankId",
                table: "CourseWords",
                column: "CourseWordRankId");
